...
Build::
  ...
  * Upgrade jruby-gradle-plugin to 2.0.0 and load Gems directly from rubygems.org instead of using torquebox Maven proxy.
...
Documentation::
  ...
  * Upgrade to Asciidoctor PDF 1.5.0
  * Upgrade to Asciidoctor EPUB3 1.5.0-alpha.13
